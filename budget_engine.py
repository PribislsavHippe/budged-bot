...
_CATEGORY_KEYWORDS: dict[str, list[str]] = {
    ...
    "Жильё": [
        ...
        "газ", "жкх", "квартплат", "водоснабжение", "отопление",
        "домофон", "управляющая", "капремонт", "тко", "вывоз мусора",
        "свет", "вода", "счёт за", "счет за", "жилищ",
    ],
    "Подписки": [
...
- Категория "Жильё" включает: аренда, коммуналка, ЖКХ, квартплата, электричество, газ, вода, отопление, ТКО, домофон, капремонт
